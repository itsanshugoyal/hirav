...
const Component = () => {
  ...
  return (
    <Slider {...settings} className="shadow-2xl rounded-xl mb-24" id="component">
      {/* Slide 1 */}
      <div>
        <div className=" flex p-32 h-[680px] bg-white w-full rounded-xl ">
          <div className="flex flex-col w-2/3">
            <p className="text-4xl font-bold">First Ever Green Credit Investment Planner</p>
            <p className="text-2xl pl-4 text-gray-600 pt-3 pb-5">Empower your investments with a sustainable touch</p>
            ...
            <div className="flex gap-5 mt-14 self-start px-5 py-2 mx-auto text-xl font-extrabold text-white bg-[#3030FF] rounded-3xl ">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
              >
                <motion.div>Invest now</motion.div>
      ...
      <div>
        <div className=" flex p-32 h-[680px] bg-white w-full rounded-xl ">
          <div className="flex flex-col w-2/3">
            <p className="text-4xl font-bold">Intelligent Ai-Powered Investment Plans</p>
            <p className="text-2xl pl-4 text-gray-600 pt-3 pb-5">Transform your portfolio with tailored solutions</p>
            <ul className="text-xl grid gap-y-4 list-disc">
              <li>Expertly curated plans for optimal performance.</li>
              <li>Advanced Al for better decision-making.</li>
              <li>Personalized strategies based on your risk tolerance and goals.</li>
          ...
          <div className="flex w-[30%]">
            <img src="/img/hyperspace-mr-roboto-1.png" alt="" className="w-full  pb-20" />
          </div>
        </div>
      </div>
      {/* Slide 3 */}
      <div>
        <div className=" flex p-32 h-[680px] bg-white w-full rounded-xl ">
          <div className="flex flex-col w-2/3">
            ...
            <p className="text-2xl pl-4 text-gray-600 pt-3 pb-5">Empowering users across languages and cultures. </p>
            <ul className="text-xl grid gap-y-4 list-disc ">
              ...
              <li>Simplifies user experience for all language proficiencies.</li>
        ...
        <div className=" flex p-32 h-[680px] bg-white w-full rounded-xl ">
          <div className="flex flex-col w-2/3">
            ...
            <p className="text-2xl pl-4 text-gray-600 pt-3 pb-5">
              Our app brings all your favorite features to your fingertips with added mobility. Enjoy seamless
              investment planning, Al-driven insights, and multilingual support anytime, anywhere.{" "}
            </p>
            <p className="text-gray-600 font-bold text-2xl pt-10">
              Download Now and Elevate Your Investing Experience!
            </p>
            {/* button */}
            <div className="flex flex-row gap-5 mt-16 self-start px-5 py-2 mx-auto text-xl font-extrabold ">
              <img loading="lazy" src="/img/apple-store-1.png" className=" w-full " />
